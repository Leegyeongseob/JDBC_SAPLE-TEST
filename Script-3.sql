...
CREATE TABLE RoomInfo(
    ...
    option_id NUMBER(10) REFERENCES house_option(option_id) NOT NULL
);


INSERT INTO RoomInfo VALUES(1234567,'집가고싶다','HTTP 암튼 URL임', '매매',10000000,'148.76M^2','2024-03-29',6,'강남구 강남구 테헤란로14길 6 KH정보교육원',
'2F','강남역이랑 역삼역 10분 거리임 개?꿀? 인가?','01022221111','2024-03-29','강남에서 제일가는 명당룸',10);

-- 옵션(house_option) 테이블 생성
create table house_option(
	option_id NUMBER(10) PRIMARY KEY NOT NULL,
...
INSERT INTO love_room VALUES('평생 살고싶은 원룸','dyddnr33@naver.com',1234567);
INSERT INTO love_room VALUES('강남에서 제일가는 명당룸.','wnsdud12@daum.com',1234567);
